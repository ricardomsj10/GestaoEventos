...
namespace GerenciamentoEventosHoteis.Controllers
{
    public class HoteisController : Controller
    {
        ...
        public HoteisController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Endereco,CNPJ,ContatoPrincipal,Ativo")] Hotel hotel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Endereco,CNPJ,ContatoPrincipal,Ativo")] Hotel hotel)
        {
            if (id != hotel.Id)
            {
                return NotFound();
